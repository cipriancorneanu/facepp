...
class CascadeSdmAbstract:
    def _train_step(self, images, ground_truth, params, mapping, i, args=None):
        sample_size = None if args is None else args.get('sample_size', None)
        ...
        mean_features, pca_transform, _ = variation_modes(features, min_variance=0.97, sampling_size=sample_size)
